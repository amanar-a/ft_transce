...
export declare class friendsService {
    ...
    constructor(friendListRepo: Repository<FriendLsit>, friendShipRepo: Repository<FriendShip>, userRepo: Repository<User>, jwtService: JwtService, usersRepository: Repository<User>);
