    ...
    return (
        ...
        // </div>
         ...
         <div className={!props.LiveM ? style.player1 : styleP.player1}>
             <div className={!props.LiveM ? style.imagediv : styleP.imagediv}><img src={props.data.playerpic1} className={!props.LiveM ? style.img : styleP.img}/></div>
         ...
         <div className={!props.LiveM ? style.player2 : styleP.player2}>
             ...
             <p className={!props.LiveM ? style.userName : styleP.userName}>{props.data.playerpic2}</p>
         </div>
